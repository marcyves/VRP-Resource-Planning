...
\begin{workflowstep}[Agenda]
  \menu{Agenda} → sélectionnez \structure{}, \seance{} et \patient{}. Mode \textbf{Édition} → date, horaires → \menu{Planifier}.
\end{workflowstep}
...
\begin{workflowstep}[Facturation mensuelle]
  Accueil → cliquez sur la \structure{} → section \textbf{Facturation} (\texttt{\#billing}). Naviguez mois par mois. Vérifiez les \seance{}s et \patient{}s. Créez ou rattachez une facture (mode Édition).
\end{workflowstep}
