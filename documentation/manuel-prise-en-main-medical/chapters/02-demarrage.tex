...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}ll@{}}
    ...
    \midrule
    \menu{Agenda} & Planifier et modifier les \seance{}s (vues mois / semaine) \\
    \menu{Structures} & Liste des \structure{}s, facturation par fiche \\
    \menu{Trésorerie} & Factures, banque, rapprochement \\
    \menu{Référentiel} & Prestations et patients \\
    \bottomrule
  \end{tabular}
\end{table}

Onglets du référentiel~: \menu{Prestations} · \menu{Patients}. La préparation de facturation est sur la fiche \structure{} (\texttt{\#billing}).
