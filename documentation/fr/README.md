...
Fiches wiki : modèle métier, parcours utilisateur et **contexte terminologique** (formation vs clients/projets).

**English version:** [documentation/en/README.md](../en/README.md)

## Sommaire

| Fiche | Sujet |
|-------|--------|
| [Modèle de données — formation](modele-donnees-formation.md) | École, programme, cours, groupe et relations |
| [Parcours de création](parcours-creation-ecole.md) | Ordre des étapes et exemple 3×2×6 |
...
| [V2 — mode école mentoring](v2-mode-ecole-mentoring.md) | Libellés formation vs mentoring, panneaux fiche, switch breadcrumb |
...
| [Facturation électronique (ops)](facturation-electronique.md) | Config SuperPDP, émission, webhooks, pièges |
