...
\begin{description}[style=nextline, leftmargin=2.2cm]
  \item[Barre latérale] Menu principal compact ou étendu. Trois entrées~: \menu{Agenda}, \menu{Trésorerie}, \menu{Plan de charge}. Le logo ramène également à \texttt{/home}.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lp{9cm}@{}}
    ...
    \midrule
    Plan de charge  & Plan de charge · Écoles · Programmes · Groupes \\
    Agenda          & Planning · Calendrier (import ICS, admin) \\
    Trésorerie      & Synthèse · Factures · Créer facture · Banque · Notes de frais · Dépenses · Créer dépense \\
...
\begin{workflowstep}[Retour accueil]
  Cliquez sur le logo ou sur \menu{Plan de charge} dans la barre latérale → \texttt{/home}.
\end{workflowstep}

\begin{workflowstep}[Ouvrir une école]
  Depuis la liste, cliquez sur le nom de l'établissement → fiche détaillée (cours, adresse, documents, facturation).
\end{workflowstep}
