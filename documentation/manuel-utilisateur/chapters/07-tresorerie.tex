...
\begin{description}[style=nextline, leftmargin=2.5cm]
  \item[Synthèse] Histogramme et totaux TTC.
  \item[Factures] Liste filtrable, statut payé/impayé, PDF, bouton \textbf{Émettre e-facture} si SuperPDP est configuré.
  \item[Banque] Banques, comptes, imports de relevés \texttt{.xlsx}.
  \item[Dépenses] Notes de frais et charges autonomes (ancre \texttt{\#expense-reports}).
\end{description}

\menu{Créer facture} et \menu{Créer dépense} sont des boutons dans la page, pas des onglets. L'émission hors contexte école reste possible depuis Factures.
