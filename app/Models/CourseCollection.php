...
//        $end_date   =  date('Y-m-d H:i:s',strtotime(trim($year)."-".trim((int)$month+1)."-0 00:00:00"));
        ...
        ->select(['begin', 'end', 'location', 'courses.name as course_name','courses.short_name as short_name', 'groups.name as group_name', 'groups.short_name as group_short_name'])
