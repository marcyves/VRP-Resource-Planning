<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between md:space-x-4 p-1 mb-0">
    ...
    @foreach($occurences as $occurence)
        ...
        <li class="ml-2">{{date_format(date_create($occurence->begin),'d/m/Y H:i')}} - {{date_format(date_create($occurence->end),'d/m/Y H:i')}}</li>
        @endif
    @endforeach
    </ul>
    </x-nice-box>
