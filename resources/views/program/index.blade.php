<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Programs') }}
            <a class="inline-flex items-center p-2 text-sm border border-gray-300 rounded-md font-semibold font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none" 
    ...
    <x-nice-box color="white">
        <div class="table w-full">
            ...
            <span class="table-cell text-right">
                <form class="inline" action="{{route('program.update', $program->id)}}" method="get">
