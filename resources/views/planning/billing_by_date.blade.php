                        ...
                        @if (Auth::user()->getMode() == 'Edit')
                            <div class="billing-school-footer__actions">
                                <form action="{{ route('billing.setBill') }}" class="billing-assign-form" method="post">
                                    ...
                                    <label class="billing-assign-form__label" for="invoice_id_{{ $courses['school_id'] }}_date">{{ __('messages.bill') }}</label>
                                    <select name="invoice_id" id="invoice_id_{{ $courses['school_id'] }}_date" class="form-input billing-assign-form__select">
