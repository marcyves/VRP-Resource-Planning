...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::VCdQkbNhAuSNu3CS',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::H4XeEofpMfm92kok',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::tvW3nrOkjvNLXQNQ',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::GKO8epaTOPi9Kd3g',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::ENH394iZgRHBVDG5',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::GtRFtRHZwpYuFU73',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/translate/([^/]++)(?|/translations(?|(*:45)|/create(*:59)|(*:66))|(*:74))|/admin/calendars/(?|reimport/([^/]++)(*:119)|delete/([^/]++)(*:142))|/school/([^/]++)(?|/(?|add(*:177)|document(*:193)|edit(*:205))|(*:214))|/documents/(?|delete/([^/]++)(*:252)|([^/]++)(?|(*:271)|/edit(*:284)|(*:292)))|/co(?|urse/([^/]++)(?|/(?|create(*:334)|edit(*:346))|(*:355)|(*:363))|mpany/([^/]++)(*:386))|/group/(?|([^/]++)/create(*:420)|link/([^/]++)(*:441)|switch/([^/]++)(*:464)|unlink/([^/]++)(*:487)|([^/]++)(*:503)|create(*:517)|([^/]++)(?|(*:536)|/edit(*:549)|(*:557)))|/p(?|lanning/(?|([^/]++)(?|(*:594))|create(*:609)|store(*:622))|rogram/([^/]++)(?|(*:649)|/edit(*:662)|(*:670)))|/invoice/(?|payed/([^/]++)(*:706)|([^/]++)(?|(*:725)|/edit(*:738)|(*:746)))|/reset\\-password/([^/]++)(*:781)|/verify\\-email/([^/]++)/([^/]++)(*:821))/?$}sDu',
    ),
    3 => 
    array (
      45 => 
  ...
  array (
    ...
    array (
      ...
      'uri' => 'admin/calendars/reimport/{source}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\CalendarFileController@reimport',
        'controller' => 'App\\Http\\Controllers\\CalendarFileController@reimport',
        'namespace' => NULL,
        'prefix' => '/admin/calendars',
        'where' => 
        array (
        ),
        'as' => 'calendar.reimport',
      ),
      'fallback' => false,
      'defaults' => 
      array (
